    ...
    def trade_stocks(self):
        ...
        for row_data in buy_list :
            ...
            if split_row_data[-1].rstrip()=='매수전':
                self.kiwoom.send_order('send_order_reg', '0101', account, 1, code, num, price, hoga_lookup[hoga], '')
        ...
        for row_data in sell_list :
            ...
            if split_row_data[-1].rstrip()=='매도전':
                self.kiwoom.send_order('send_order_reg', '0101', account, 2, code, num, price, hoga_lookup[hoga], '')
